...
# Start the main loop
while true; do
    # Alternative solution, with no need for sudo password, only on Linux
    # Thanks to @blackdaemon, fd2e62e (https://github.com/karpathy/ulogme/commit/fd2e62e665c49dcb5c94acc559abc696d8951232)
